...
* For the reflections we use an importance sampled GGX function, once again for better ray convergence.
* 
* Ideally, more work should be done to improve quality at lower samples (we have access to mips)
*/

Shader "Unlit/BoxProjectedLightingV4"
{
    Properties
    {
        ...
        [IntRange] _ReflectionSamples("Reflection Samples", Range(1, 512)) = 64
            ...
            float4 fragment_forward_base(vertexToFragment i) : SV_Target
            {
                ...
                // Compute the direct bounce lighting term.
                    ...
                    for (int i = 1; i <= _BounceSamples; i++)
                    {
                        ...
                        bounceLightSample *= _LightColor0.rgb * 0.5;
